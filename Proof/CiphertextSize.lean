...
/-- The construction-facing corollary: every garbling of every tape is `1100521` bytes, because
...
theorem ciphertextBytesConstant_eq : ciphertextBytesConstant = 1100521 := rfl
